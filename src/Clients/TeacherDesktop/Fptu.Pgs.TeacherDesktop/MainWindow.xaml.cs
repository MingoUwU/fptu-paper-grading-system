...
public partial class MainWindow : Window
{
    ...
    private static readonly IReadOnlyDictionary<string, LocalizedText> Texts =
        new Dictionary<string, LocalizedText>(StringComparer.Ordinal)
        {
            ...
            ["Dashboard.NextStepDescription"] = new("Theo dõi số lượng bài chờ xử lý, kết quả AI và trạng thái hoàn tất chấm điểm.", "Monitor pending submissions, AI results, and finalized grading status."),
            ...
            ["Exams.Imported"] = new("Đề thi đã được nhập thành công. Vui lòng cấu hình tiêu chí chấm.", "The exam was imported successfully. Configure its grading criteria."),
            ["Exams.LoadedFormat"] = new("Đã tải {0} đề thi.", "Loaded {0} exams."),
            ["Exams.SelectFirst"] = new("Vui lòng chọn một đề thi.", "Please select an exam."),
            ...
            ["Exams.RubricDescription"] = new("Cấu hình rubric và tiêu chí chính thức để AI sử dụng khi chấm bài.", "Configure the official rubric and criteria used by AI grading."),
            ...
            ["Upload.DropPlaceholder"] = new("Khu vực tiếp nhận file bài làm để chuyển đến Submission Service và Document Processing Service.", "Submission file intake area for Submission Service and Document Processing Service."),
            ...
            ["Reports.CenterDescription"] = new("Theo dõi độ lệch giữa điểm AI và giảng viên, xuất báo cáo Excel/PDF và tra cứu audit log.", "Review AI/teacher score differences, export Excel/PDF reports, and search audit logs."),
            ...
            ["Credential.Required"] = new("Vui lòng nhập Gemini API key trước khi lưu.", "Please enter a Gemini API key before saving."),
            ...
            ["Review.LoadFirst"] = new("Vui lòng tải kết quả AI trước khi chấm lại.", "Please load the AI result before re-grading."),
            ...
            ["Review.FinalizeFirst"] = new("Vui lòng tải và hoàn tất chấm lại trước khi xác nhận điểm.", "Please load and complete the re-grade before finalizing the score."),
            ...
            ["Message.LoginRequired"] = new("Vui lòng đăng nhập để tiếp tục.", "Please sign in to continue."),
            ...
            ["Login.Required"] = new("Vui lòng nhập email và mật khẩu.", "Please enter your email and password."),
            ...
            ["Users.SelectUser"] = new("Vui lòng chọn một tài khoản.", "Please select an account."),
